...
export class HRISService extends NetworkService {
  constructor(
    protected httpClient: HttpClient,
    protected errorHandler: HttpErrorHandler) {
    super('HRISService', httpClient, errorHandler);
  }
  ...
  getList(criteria: any = undefined): Observable<ApiResponse> {
    ...
    return this.post(API_ENDPOINT.HRIS.LIST, body);
  }
  ...
  getDetail(refStageId: string, jrId: string, tabName: string, criteria: any = undefined): Observable<ApiResponse> {
    ...
    return this.post(API_ENDPOINT.HRIS.DETAIL, body);
  }
