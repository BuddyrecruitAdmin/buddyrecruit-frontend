...
@Component({
  selector: 'ngx-hris-list',
  templateUrl: './hris-list.component.html',
  styleUrls: ['./hris-list.component.scss']
})
export class HRISListComponent implements OnInit {
  role: any;
  items: any;
  ...
  edit(item: any) {
    ...
    this.router.navigate(["/employer/hris/detail"]);
  }
