...
export class RejectStageService extends NetworkService {
  constructor(
    protected httpClient: HttpClient,
    protected errorHandler: HttpErrorHandler) {
    super('RejectStageService', httpClient, errorHandler);
  }

  getList(criteria: any = undefined): Observable<ApiResponse> {
    return this.post(API_ENDPOINT.CONFIGURATION.REJECT_STAGE_LIST, { criteria });
  }
  ...
  edit(item: any): Observable<ApiResponse> {
    return this.post(API_ENDPOINT.CONFIGURATION.REJECT_STAGE_EDIT, item);
  }
